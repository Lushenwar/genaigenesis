...
import MapView, { ZoneBounds } from "@/components/MapComponent";
import {
  Loader2,
  TreePine,
  ArrowLeft,
...
interface Zone {
  ...
  bounds: ZoneBounds;
  metrics: { priority_1_cell_count: number; area_sq_m: number };
}
                  ...
                  >
                    ...
                    <div className="flex gap-4 mt-1.5 text-[10px] text-zinc-500">
                      <span className="text-red-400/80 font-medium">
                        {zone.metrics.priority_1_cell_count} critical cells
                      </span>
                      <span>
                        {(zone.metrics.area_sq_m / 1000).toFixed(0)}k m²
                      </span>
                    </div>
                  </button>
                ))}
            ...
            <>
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-3 mt-1 text-[10px] text-zinc-500">
                  <span>
                    {selectedZone.metrics.priority_1_cell_count} critical cells
                  </span>
                  <span>
                    {(selectedZone.metrics.area_sq_m / 1000).toFixed(0)}k m²
                  </span>
                </div>
              </div>
